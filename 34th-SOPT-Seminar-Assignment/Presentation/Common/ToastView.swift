...
final class ToastView: UIView {
    ...
    private let subTitleLabel: UILabel = {
        let label = UILabel()
        label.font = UIFont.pretendardFont(ofSize: 13, weight: 400)
    ...
    private lazy var moveButton: UIButton = {
        ...
        button.titleLabel?.font = UIFont.pretendardFont(ofSize: 15, weight: 600)
    ...
    init(type: ToastType, backgroundColor: UIColor? = .darkGray) {
        ...
        switch type {
        case .soldout:
            messageLabel.font = UIFont.pretendardFont(ofSize: 12, weight: 500)
